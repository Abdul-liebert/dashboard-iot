        ...
        <div class="row align-items-center g-4">
            <div class="col-lg">
                ...
                <div class="container container-tight py-4">
                    ...
                    <div class="text-center text-secondary mt-3">Don't have account yet? <a href="/register"
                            tabindex="-1">Sign
                            up</a></div>
                </div>
            </div>
            <div class="col-lg d-none d-lg-block">
                <svg class="w-100 h-auto" xmlns="http://www.w3.org/2000/svg" width="800" height="600"
